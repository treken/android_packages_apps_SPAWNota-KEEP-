...
package com.spawn.updater.util;
...
import com.spawn.updater.DownloadService;
import com.spawn.updater.MainActivity;
import com.spawn.updater.NotificationAlarm;
import com.spawn.updater.R;
import com.spawn.updater.updater.Updater;
import com.spawn.updater.util.RequestFileActivity.RequestFileCallback;
...
public class Constants {
    ...
    public static final String OVERLAY_GAPPS_URL = "ro.spawn.gapps_url";
    public static final String OVERLAY_GAPPS_VERSION = "ro.spawn.gapps_version";
    ...
    public static boolean isSystemApp(Context context) throws Exception {
        ...
        PackageInfo info = pm.getPackageInfo("com.spawn.updater",
