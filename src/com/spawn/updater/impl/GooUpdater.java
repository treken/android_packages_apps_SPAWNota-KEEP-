...
package com.spawn.updater.updater.impl;

import org.json.JSONObject;

import android.util.Log;

import com.spawn.updater.updater.GooPackage;
...
public class GooUpdater extends Updater {
    ...
    private void searchGoo() {
        mScanning = true;
        new URLStringReader(this).execute("http://spawn.net/api/?device=" + getDevice());
	    //Log.i(DEBUG_TAG, "http://spawn.net/api/?device=" + getDevice());
    }
